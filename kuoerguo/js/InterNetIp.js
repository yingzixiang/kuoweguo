...
var urlStr;
$(function(){
if (str1 == "Ip.html") urlStr = "http://"+realname+"/v1/ipnet/";
else urlStr = "http://"+realname+"/v1/ipnetwl/";	
})
/*删除功能*/
var str = window.location.href;
var nums=str.substring(str.indexOf("?")+1);
...
function OutNetAdd(){
    ...
    if(outNet == '' || outNet == null || outNet == 'undefined'){
        ...
        var html = '' ;
    	postdata = {"ClientsetId":parseInt(nums),"Ipnet":outNet,"Mask":parseInt(outMask)}
       	$.ajax({
	 			url: urlStr,
	 			type:'post',
	 			dataType:'json',
